function convidadoSelecao(event, id) {
  ...
  if (id == "box-AH") {
    ...
    if (convidadoPainel.classList == 'JP', 'KB', 'LB', 'PDT', 'AC') {
      convidadoPainel.classList.remove('JP', 'KB', 'LB', 'PDT', 'AC')
    }
  }
  else if (id == "box-JP") {
    convidadoPainel.classList.add('JP')
    if (convidadoPainel.classList == 'AH', 'KB', 'LB', 'PDT', 'AC'){
      convidadoPainel.classList.remove('AH', 'KB', 'LB', 'PDT', 'AC')
    }
  }
  else if (id == "box-KB"){
    ...
    if (convidadoPainel.classList == 'AH', 'JP', 'KB', 'PDT', 'AC'){
      convidadoPainel.classList.remove('AH', 'JP', 'KB', 'PDT', 'AC')
    }
  }
  else if (id == "box-PDT"){
    convidadoPainel.classList.add('PDT')
    if (convidadoPainel.classList != 'AH', 'JP', 'KB', 'LB', 'AC'){
      convidadoPainel.classList.remove('AH', 'JP', 'KB', 'LB', 'AC')
    }
  }
  else if (id == "box-AC"){
    convidadoPainel.classList.add('AC')
    if (convidadoPainel.classList != 'AH', 'JP', 'KB', 'LB', 'PDT'){
      convidadoPainel.classList.remove('AH', 'JP', 'KB', 'LB', 'PDT')
    }
  }
}
